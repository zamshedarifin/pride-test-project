                ...
                <div class="col-md-8 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{route('admin.productUpdate',$product->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="color">
                                                @foreach($colors as $color)
                                                    <option value="{{$color->id}}" {{$product->album_id == $color->id ? 'selected' : ''}}> {{$product->color->color_name}}</option>
                                                @endforeach
                                            </select>
                                            @if($errors->has('color'))
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" id="mark" value="{{$product->price}}" placeholder="Price"
                                                   class="form-control">
                                            @if($errors->has('price'))
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if($product->thumbnail)
                                        <img src="{{asset('uploads/product/'.$product->thumbnail)}}"
                                             class="card-img rounded h-100 w-100"
                                             alt="...">
                                    @else
                                        <img src="{{asset('admin/images/thumb.png')}}"
                                             class="card-img rounded h-100 w-100"
                                             alt="...">
                                    @endif
                                </div>
